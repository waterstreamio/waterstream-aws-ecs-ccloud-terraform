...
#TLS_BASE_FOLDER=/var/waterstream-resources/tls

ROOT_CA_FOLDER=$TLS_BASE_FOLDER/root
ROOT_CA_CNF=$ROOT_CA_FOLDER/waterstream_demo_ca.cnf
ROOT_CA_KEY=$ROOT_CA_FOLDER/waterstream_demo_ca.key
ROOT_CA_CERT=$ROOT_CA_FOLDER/waterstream_demo_ca.pem
