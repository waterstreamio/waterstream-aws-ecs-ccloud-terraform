...
$CREATE_TOPIC $DEFAULT_MESSAGES_TOPIC --cluster ${CLUSTER_ID}  --partitions ${DEFAULT_MESSAGES_TOPIC_PARTITIONS} --config cleanup.policy=delete --config retention.ms=$WEEK_MS || true
